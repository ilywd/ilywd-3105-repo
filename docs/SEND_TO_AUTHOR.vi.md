# Nội dung gửi tác giả 3105

Chào bạn, mình đã tạo một repository độc lập dùng đúng Repository schema v1 của
3105. Repo không yêu cầu sửa patch engine, giao diện hay cấu trúc mã nguồn 3105.

Repository:

```text
https://github.com/ilywd/ilywd-3105-repo
```

Manifest dùng để thêm trong tab Nguồn:
